...
export class AuthController {
  ...
  @ApiResponse({status: 200, description: 'Password has been successfully updated'})
  ...
  @ApiResponse({status: 200, description: 'password reset successful, proceed to login'})
  ...
  @ApiResponse({status: 200, description: 'Two Factor Authentication Successfully activated'})
  @ApiResponse({status: 401, description: 'Unable to activate two factor authentication'})
  ...
  @ApiResponse({status: 200, description: 'Two Factor Authentication sucessfully verified'})
  @ApiResponse({status: 401, description: 'Error verifying Two Factor Authentication'})
  async verifyMfa(
